...
insert into achados values ('a2','templos de angkor',null,'bo',null,'pa6');
insert into achados values ('a3','hipogeum',null,'bo',null,'pa5');
insert into achados values ('a4','tumba de nefertiti',null,'bo',null,'pa2');
insert into achados values('a5','balsa muisca',null,'bo',null,'pa7');
insert into achados values('a6','busto de nefertiti',null,'bo',null,'pa2');
insert into achados values('a7','piedra del sol',642,'bo',null ,'pa1');
insert into achados values('a8','dama durminte',null,'bo',null,'pa5');
insert into achados values('a9','mascara de tutankamon',null,'bo','d2','pa2');
...
insert into achados values('a12','pedra de rosseta',null,'medio','d1','pa2');
insert into achados values('a13','cabeza nur',null,'medio','d1',null);
...
insert into museos values ('m1','museo do ouro' , 'pa7');
insert into museos values ('m2','museo arqueoloxico de valleta' , 'pa5');
insert into museos values ('m3','museo nacional de antropoloxia' , 'pa1');
insert into museos values ('m4','museo exipcio de berlin ','pa9');
insert into museos values ('m5','museo de historia natural de viena ','pa0');
insert into museos values ('m6','museo exipcio de el cairo ','pa2');
insert into museos values ('m7','museo ulm','pa9');
insert into museos values ('m8','museo britanico de londres','pa8');
